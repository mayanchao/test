...
import com.mana.autoBuild.daoVO.BaseAutoBuildVO;
 public class SelfhelpTempletPrototypeVO extends BaseAutoBuildVO{ 
    public String id;
    public String type;
...
public void setLocationJson( String locationJson){
 ...
 SelfhelpTempletPrototypeVO vo = new SelfhelpTempletPrototypeVO(); 
 try{
 ...
 vo.locationJson = resultSet.getString("location_Json"); 
  ...
  return "selfhelp_templet_prototype"; 
  }
  @Override 
